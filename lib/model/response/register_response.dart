import '../entity/contact_detail.dart';
...
class RegisterResponse {
  ...
  RegisterResponse({this.message, this.data, this.errorMessage});
...
class RegisterData {
  ...
  RegisterData({this.registerUser, this.isProfileFullfilled});

  RegisterData.fromJson(Map<String, dynamic> json) {
    registerUser = json['data'] != null ? new RegisterUser.fromJson(json['data']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.registerUser != null) {
      data['data'] = this.registerUser.toJson();
    }
